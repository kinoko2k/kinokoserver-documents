...
- **idk**
idkはI don't know.の略。
これも文を見れば意味が分かるが、「私は知らない」「わからない」ということ。
...
打つべきキーが全て1つずつ右にずれだことで生じるタイプミスである。

言葉派生して、npm(パッケージ管理の管理するツール)
...
## な行
- **Negirar権限**
2023年10月に追加された、お遊びで追加された新しい権限。「値切ろう」という言葉が語源。なお、この鯖にこの追加された時点では、経済プラグインなどは導入されていない。
